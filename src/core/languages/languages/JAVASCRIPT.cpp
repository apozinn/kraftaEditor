...
// Made constexpr and properly formatted
constexpr const char* reservedWords1 =
...
constexpr const char* reservedWords2 =
...
constexpr const LanguageInfo JAVASCRIPT_PREFS = {
    "Javascript",
    "javascript",
    "*.js;*.jsx",
    wxSTC_LEX_CPP,
