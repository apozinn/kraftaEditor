...
EVT_MENU(ID_TOGGLE_FILE_TREE_VIEW, MainFrame::OnHiddeFilesTree)
EVT_MENU(ID_TOGGLE_MENU_BAR_VIEW, MainFrame::OnHiddeMenuBar)
EVT_MENU(ID_TOGGLE_STATUS_BAR_VIEW, MainFrame::OnHiddeStatusBar)
EVT_MENU(ID_TOGGLE_TAB_BAR_VIEW, MainFrame::OnHiddeTabs)
